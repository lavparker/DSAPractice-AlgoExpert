// Difficulty:
// Category: Strings Successful Submissions: 15,270+
// Valid IP Addresses
...
// "192.168.0.1" is a valid IP address, but "192.168.00.1" and "192.168.0.01" aren't, because they contain "00" and 01, respectively. Another example of a valid IP address is "99.1.1.10"; conversely, "991.1.1.0" isn't valid, because "991" is greater than 255.
...
// Note: check out our Systems Design Fundamentals on SystemsExpert to learn more about
// IP addresses!
...
function isValid(string){
  ...
  if(num > 255 || num < 0 || (string.length > 1 && string[0] === "0")){
    return false;
  }
